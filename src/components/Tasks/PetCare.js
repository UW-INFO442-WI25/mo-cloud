          ...
          <div className="flex-1 order-1 lg:order-2">
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <div className="flex-1 relative">
                ...
                />
                <svg className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="bg-white rounded-3xl p-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Pet Care Tasks</h2>
