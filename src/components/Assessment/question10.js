...
const Question10 = () => {
  ...
  const questionIndex = 9; // Question 10 index
  ...
  const handleOptionSelect = (index) => {
    ...
    navigate("/self-assessment/results", { state: { scores: newScores, updateScore } });
  };
    ...
    <div className="min-h-screen bg-[#002B5C]">
      ...
      <div className="container mx-auto px-8 py-8">
        <div className="max-w-4xl mx-auto bg-[#003471] rounded-3xl p-12">
          <h2 className="text-3xl font-bold text-white mb-12">How often do you receive acknowledgment or appreciation for the household labor you do?</h2>
          ...
          <div className="flex justify-between mt-6">
            ...
            <button
              onClick={() => navigate("/self-assessment/results", { state: { scores, updateScore } })}
