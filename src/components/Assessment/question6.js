...
const Question6 = () => {
  ...
  const questionIndex = 5; // Question 6 index
  ...
  const handleOptionSelect = (index) => {
    ...
    navigate("/self-assessment/question7", { state: { scores: newScores, updateScore } });
  };
    ...
    <div className="min-h-screen bg-[#002B5C]">
      ...
      <div className="container mx-auto px-8 py-8">
        <div className="max-w-4xl mx-auto bg-[#003471] rounded-3xl p-12">
          <h2 className="text-3xl font-bold text-white mb-12">Do you feel the household labor is distributed fairly in your household?</h2>
          ...
          <div className="flex justify-between mt-6">
            ...
            <button
              onClick={() => navigate("/self-assessment/question7", { state: { scores, updateScore } })}
