...
const Question2 = () => {
  ...
  const questionIndex = 1; // Question 2 index
  ...
  const handleOptionSelect = (index) => {
    ...
    navigate("/self-assessment/question3", { state: { scores: newScores, updateScore } });
  };
    ...
    <div className="min-h-screen bg-[#002B5C]">
      ...
      <div className="container mx-auto px-8 py-8">
        <div className="max-w-4xl mx-auto bg-[#003471] rounded-3xl p-12">
          <h2 className="text-3xl font-bold text-white mb-12">How do you prioritize household tasks?</h2>
          ...
          <div className="flex justify-between mt-6">
            ...
            <button
              onClick={() => navigate("/self-assessment/question3", { state: { scores, updateScore } })}
