      ...
      <div className="container mx-auto px-8 py-8">
        <div className="max-w-4xl mx-auto bg-[#003471] rounded-3xl p-12">
          ...
          <div className="space-y-2 mb-12">
            ...
            <p className="text-gray-300 text-lg">e.g., remembering schedules, planning meals, organizing chores</p>
          </div>
          ...
          <div className="flex justify-center">
            <button
              onClick={() => navigate("/self-assessment/question4")}
          ...
          <div className="flex justify-center gap-2 mt-8">
            {[...Array(10)].map((_, i) => (
              <div key={i} className={`w-2 h-2 rounded-full ${i === 2 ? "bg-[#64B5F6]" : "bg-white/20"}`} />
            ))}
          </div>
        </div>
      </div>
